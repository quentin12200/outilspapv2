...
class PAPEnrichmentService:
    ...
    def _format_siret_summary(self, summary: SiretSummary) -> Dict[str, Any]:
        ...
        return {
            ...
            'voix_cgt_c3': summary.cgt_voix_c3,
            'voix_cfdt_c3': summary.cfdt_voix_c3,
            'voix_fo_c3': summary.fo_voix_c3,
            'voix_cftc_c3': summary.cftc_voix_c3,
            'voix_cfe_cgc_c3': summary.cgc_voix_c3,
            'voix_unsa_c3': summary.unsa_voix_c3,
            'voix_solidaires_c3': summary.solidaire_voix_c3,
            'voix_autre_c3': summary.autre_voix_c3,
            # Scores électoraux C4
            'voix_cgt_c4': summary.cgt_voix_c4,
            'voix_cfdt_c4': summary.cfdt_voix_c4,
            'voix_fo_c4': summary.fo_voix_c4,
            'voix_cftc_c4': summary.cftc_voix_c4,
            'voix_cfe_cgc_c4': summary.cgc_voix_c4,
            'voix_unsa_c4': summary.unsa_voix_c4,
            'voix_solidaires_c4': summary.solidaire_voix_c4,
            'voix_autre_c4': summary.autre_voix_c4,
            # Élus (sièges)
            'elus_cgt_c3': summary.cgt_siege_c3,
            'elus_cgt_c4': summary.cgt_siege_c4,
            # Inscrits
            'inscrits_c3': summary.inscrits_c3,
            'inscrits_c4': summary.inscrits_c4,
            # Présence CGT (calculé)
            'presence_cgt_c3': summary.cgt_voix_c3 is not None and summary.cgt_voix_c3 > 0,
            'presence_cgt_c4': summary.cgt_voix_c4 is not None and summary.cgt_voix_c4 > 0,
            # Dates
